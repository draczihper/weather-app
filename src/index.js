...
const displayForecastContainer = document.querySelector(
    "[data-display-forecast-container]",
);
...
function domDisplay() {
    const addressSection = new CreateElement(
        "section",
        "class",
        "address",
        "",
    ...
    const addressDiv = new CreateElement(
        "div",
        "id",
        "address",
        "",
    ...
    const addressH3 = new CreateElement(
        "h3",
        "",
        "",
        forecastData.address,
        addressDiv,
    );
    const resolvedAddressH5 = new CreateElement(
        "h5",
        "",
        "",
    ...
    const lat_longDiv = new CreateElement(
        "div",
        "id",
        "lat-long",
        "",
    ...
    const timezoneP = new CreateElement(
        "p",
        "",
        "",
    ...
    const descriptionDiv = new CreateElement(
        "div",
        "id",
        "description",
        "",
    ...
    const descriptionP = new CreateElement(
        "p",
        "",
        "",
    ...
    const forecastSection = new CreateElement(
        "section",
        "class",
        "forecast",
        "",
    ...
    Object.keys(weatherElements).forEach((key) => {
        ...
        const rowHead = new CreateElement(
            "th",
            "",
            "",
        ...
        Object.entries(weatherDay).forEach(([key, value]) => {
            for (let j = 0; j < tableRows.length; j++) {
                if (key === tableRows[j].dataset.value) {
                    const tableData = new CreateElement(
                        "td",
                        "",
                        "",
                        `${value}`,
